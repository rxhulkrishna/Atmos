function HourSlot({time, icon, temp, rain, isActive}) {
  return (
    <div className={`flex flex-col flex-1 flex-shrink-0 items-center text-sm min-w-[80px] gap-1 py-4 px-2 ${isActive ? 'bg-neutral-700 border border-neutral-400 rounded-xl' : ''}`}>
